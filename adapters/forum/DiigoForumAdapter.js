...
class DiigoForumsAdapter extends BaseAdapter {
          ...
          messages: [
            {
              role: "system",
              content:
                'You are a JSON-only generator. You must output ONLY a valid JSON array from this fixed list: ["Business", "Gaming", "SEO", "Health", "Education", "Technology", "Finance", "Travel", "Lifestyle", "News"]. Example: ["Technology", "SEO"]. No explanations or additional text.',
            },
            {
              role: "user",
              content: prompt,
  ...
  async publish() {
    this.log(
      `[EVENT] Entering DiigoForumsAdapter publish method.`,
      "info",
      true,
    );
    let browser;
    ...
    try {
      ...
      try {
        ...
        this.log(
          "[EVENT] Login successful - redirected to dashboard.",
          "info",
          true,
        );
      } catch (urlError) {
      ...
      this.log(
        "[EVENT] Waiting for page to load completely...",
        "detail",
        false,
      );
      ...
      this.log(
        "[EVENT] Checking if we need to join this group...",
        "detail",
        false,
      );
      ...
      this.log(
        "[EVENT] Now part of the group, creating topic post...",
        "info",
        true,
      );
      ...
      this.log(
        "[EVENT] Navigating directly to new topic creation URL...",
        "detail",
        false,
      );
      ...
      this.log(
        `[EVENT] Navigating to new topic URL: ${newTopicUrl}`,
        "info",
        true,
      );
      ...
      const newTopicCloudinaryResult = await cloudinary.uploader.upload(
        newTopicScreenshotPath,
      );
      fs.unlinkSync(newTopicScreenshotPath);
      this.log(
        `[DEBUG] New topic form screenshot: ${newTopicCloudinaryResult.secure_url}`,
        "info",
        true,
      );
      ...
      this.log(
        "[EVENT] Filling title field for topic post...",
        "detail",
        false,
      );
      try {
        ...
        for (const selector of possibleTitleSelectors) {
          try {
            ...
            this.log(
              `[EVENT] Found title input with selector: ${selector}`,
              "info",
              true,
            );
            break;
            ...
            this.log(
              `[DEBUG] Title selector ${selector} not found, trying next...`,
              "detail",
              false,
            );
            continue;
        ...
        if (titleInput && foundTitleSelector) {
          ...
          this.log(
            `[WARNING] Could not find title input field`,
            "warning",
            true,
          );
        }
      ...
      this.log(
        "[EVENT] Filling comment/content field for topic post...",
        "detail",
        false,
      );
      try {
        ...
        if (urlToAppend) {
          contentToPost += `\n\n${urlToAppend}`;
          this.log(
            `[EVENT] Appended URL to content: ${urlToAppend}`,
            "info",
            true,
          );
        }
      ...
      try {
        ...
        for (const selector of possibleTagsSelectors) {
          try {
            ...
            this.log(
              `[EVENT] Found tags input with selector: ${selector}`,
              "info",
              true,
            );
            break;
            ...
            this.log(
              `[DEBUG] Tags selector ${selector} not found, trying next...`,
              "detail",
              false,
            );
            continue;
        ...
        if (tagsInput && foundTagsSelector) {
          ...
          this.log(
            `[INFO] No tags field found in topic form - skipping tags`,
            "info",
            true,
          );
        }
        ...
        this.log(
          `[WARNING] Could not fill tags field: ${tagsError.message}`,
          "warning",
          true,
        );
      ...
      try {
        ...
        for (const selector of possiblePostSelectors) {
          try {
            ...
            this.log(
              `[EVENT] Found Post button with selector: ${selector}`,
              "info",
              true,
            );
            break;
            ...
            this.log(
              `[DEBUG] Post selector ${selector} not found, trying next...`,
              "detail",
              false,
            );
            continue;
        ...
        if (!postButton || !foundPostSelector) {
          throw new Error(
            "Could not find Post/Submit button with any of the attempted selectors",
          );
        }

        this.log(
          "[EVENT] Found Post button - submitting topic...",
          "info",
          true,
        );
      ...
      this.log(
        "[EVENT] Navigating back to group page to find our newly posted topic...",
        "info",
        true,
      );
      ...
      this.log(
        "[EVENT] Getting permalink of the newly posted topic...",
        "detail",
        false,
      );
      let permalink = null;
      ...
      try {
        ...
        this.log(
          "[EVENT] Looking for our newly posted topic (title_link_0)...",
          "info",
          true,
        );
        ...
        try {
          ...
          this.log(
            `[EVENT] Got permalink of our newly posted topic: ${permalink}`,
            "success",
            true,
          );
        } catch (specificError) {
          ...
          this.log(
            "[DEBUG] Could not find #title_link_0, trying first post title...",
            "detail",
            false,
          );
          ...
          this.log(
            `[EVENT] Got permalink from first post: ${permalink}`,
            "success",
            true,
          );
        }
